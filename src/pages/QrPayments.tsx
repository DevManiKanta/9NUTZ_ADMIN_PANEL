...
//       dispatch({ type: "orders/updateStatus", payload: { id, status: nextStatus } });
//   }
        ...
        <div className="bg-white border rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="px-4 sm:px-6 py-3 sm:py-4 border-b">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
              ...
              <div className="text-xs sm:text-sm text-gray-600">
                Showing <span className="font-medium">{rows.length}</span> records
              </div>
            </div>

            {/* loader / error indicators */}
            <div className="mt-1">
              {activeTab === "online" ? (
                <>
                  {loadingOnline && <span className="text-xs text-gray-500">Loading online orders…</span>}
